...
// WK 14 Create PetStore Controller
// Wk 15 Add @Post and @Get Mapping 
...
public class PetStoreController {
	...
	log.info("Adding Employee {} to the pet store with ID={}", petStoreEmployee,
			petStoreId);
	...
	log.info("Adding Customer {} to the pet store with ID={}", petStoreCustomer,
			petStoreId);
	...
	public List<PetStoreData> retriveAllPetStores() {
		log.info("retreive all pet stores");
	return petStoreService.retrieveAllPetStores();
	}
	@GetMapping("/{petStoreId}")
	public PetStoreData retrivePetStoreById(@PathVariable Long petStoreId) {
		log.info("retreive all pet stores with ID=()", petStoreId);
